(() => {
  ...
  // docs/js/instant-wild.js
  function initInstantWild(root) {
    var categories = {
  ...
  `;
    ...
    function updateOverlay(photo) {
      ...
      var seq = String(Math.floor(Math.random() * 9e3) + 1e3);
    ...
    function showResult(correct, message) {
      ...
      $(".iw-score").textContent = "Score: " + score2;
    ...
    $(".iw-next-btn").addEventListener("click", function() {
      loadPhoto();
    });
    shuffle(photos);
    loadPhoto();
